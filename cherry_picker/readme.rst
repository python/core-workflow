...
If a GitHub `personal access token <https://help.github.com/articles/creating-a-personal-access-token-for-the-command-line/>`_
was specified as an environment variable, the pull request will be created
automatically.
...
On the command line (MacOS and Unix systems)::
